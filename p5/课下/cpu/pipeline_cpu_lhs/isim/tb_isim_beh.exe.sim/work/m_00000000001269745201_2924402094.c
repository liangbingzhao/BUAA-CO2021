...
#endif
static const char *ng0 = "E:/Verilog_tool/p5plus/pipeline_cpu_lhs/DM.v";
static int ng1[] = {0, 0};
...
LAB70:    t11 = ((char*)((ng4)));
    t28 = xsi_vlog_unsigned_case_compare(t29, 32, t11, 32);
    if (t28 == 1)
        goto LAB71;
...
LAB71:    xsi_set_current_line(122, ng0);
    ...
    *((unsigned int *)t30) = t39;
    t40 = *((unsigned int *)t43);
    *((unsigned int *)t43) = (t40 & 4095U);
    t41 = *((unsigned int *)t30);
    *((unsigned int *)t30) = (t41 & 4095U);
    xsi_vlog_generic_get_array_select_value(t33, 32, t14, t18, t27, 2, 1, t43, 12, 2);
    t34 = (t0 + 2568);
...
LAB75:    xsi_set_current_line(124, ng0);
    ...
    *((unsigned int *)t43) = (t25 & 4095U);
    t26 = *((unsigned int *)t18);
    *((unsigned int *)t18) = (t26 & 4095U);
    xsi_vlog_generic_get_array_select_value(t33, 32, t9, t13, t16, 2, 1, t43, 12, 2);
    t27 = (t0 + 2568);
...
{
	static char *pe[] = {(void *)Initial_44_0,(void *)Always_49_1,(void *)Always_93_2};
